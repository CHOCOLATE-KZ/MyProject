...
total_score = 0
total_score_text = c.create_text(10,30, anchor="nw", font=game_font, fill="darkblue", text="TOTAL SCORE:" + str(total_score))

lives_remaining = 3
lives_text = c.create_text(canvas_width - 10, 10, anchor="ne", font=game_font, fill="darkblue",
                           text="HP: " + str(lives_remaining))
